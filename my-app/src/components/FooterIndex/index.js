                        ...
                        <div className="col-12 md:col-6 lg:col">
                            <div className=" h-full">
                                <div className="h-full flex flex-column">
                                    <div className="title">Nha Khoa Á Châu</div>
                                    <hr className="hr" />
                        ...
                        <div className="col-12  md:col-6 lg:col">
                            <div className=" h-full">
                                <div className="  h-full flex flex-column">
                                    ...
                                    <hr className="hr" />
                                    <div className="text-500 text-xl pt-5">Á Châu giành nhiều giải thưởng
                                    </div>
                                    <ul className="list-none p-0 m-0 flex-grow-1 pt-5">
                                        <li className="flex align-items-center mb-3">
                        ...
                        <div className="col-12  md:col-6 lg:col">
                            <div className=" h-full">
                                <div className="  h-full flex flex-column">
                                    ...
                                    <hr className="hr" />
                                    <div className="text-500 text-xl pt-5">Truy cập Á Châu trên các liên kết xã hội này và kết nối với chúng tôi. Đảm bảo theo dõi tài khoản của chúng tôi để cập nhật thường xuyên
                                    </div>
