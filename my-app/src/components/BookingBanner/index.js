...
const BookingBanner = () => {
  ...
  const services = [
      { name: 'Nha khoa tổng quát', code: 'DV01' },
      { name: 'Cấy ghép', code: 'DV02' },
      { name: 'Phẫu thuật nha khoa', code: 'DV03' },
      { name: 'Căn chỉnh', code: 'DV04' },
      { name: 'Làm trắng', code: 'DV05' },
      { name: 'Niềng răng', code: 'DV06' },
      { name: 'Chân giả', code: 'DV07' },
      { name: 'Bảo vệ răng', code: 'DV08' },
    ]
        ...
        <div className="border-top-1 border-300 mt-4">
          <div className="mt-6 flex flex-column md:flex-row align-item-center column-gap-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full flex row-gap-5 flex-column">
              ...
              <button 
                type="submit" 
                className="text-white py-4 text-2xl border-round-lg bg-primary1 pointer-events-auto"
