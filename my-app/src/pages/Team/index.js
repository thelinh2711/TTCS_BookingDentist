        ...
        return (<>
            <div className="product-item">
                <div className="product-item-content text-center">
                    <div className="mb-3">
                        <img width='15%' src={`https://www.nhakhoaquocteachau.vn/${team?.avatar}`} onError={(e) => e.target.src = 'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} className="product-image" />
                    </div>
                    <div>
                                ...
                                <div className='px-8 grid mt-8'>
                                    <div className='col-12 md:col-6 lg:col md:text-left mb-6 text-center'>
                                        <div className='image-doctor'>
                                            <img style={{ borderBottom: '3px solid var(--primary)', verticalAlign: 'middle' }} width='80%' src={item?.avatar ? 'https://www.nhakhoaquocteachau.vn/' + item.avatar : 'https://jieh.vn/upload/images/doctor/Bac%20sy%20Hattori%20Tadashi.png'} />
                                        </div>
                                    </div>
                                    <div className='col-12 md:col-6 lg:col'>
