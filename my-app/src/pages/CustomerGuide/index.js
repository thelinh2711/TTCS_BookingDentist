                ...
                <div className='mx-auto px-5 w-default'>
                    <div className='grid'>
                        <div className='col-12 md:col-9 lg:col-9'>
                            <h1 style={{ color: 'var(--primary)' }}> Hướng dẫn khách hàng | Phòng khám nha khoa Á Châu</h1>
                            <Accordion className='my-7' multiple activeIndex={[0]}>
                                <AccordionTab className='text-2xl' header="Thời gian làm việc">
                                    <p >Phòng khám nha khoa Á Châu làm việc từ thứ 2 đến Chủ nhật.</p>
                                    <div className='py-5'>
                                ...
                                <AccordionTab className='text-2xl' header="Đặt lịch khám">
                                    ...
                                    <div className='pt-5'>
                                        ...
                                        <ul className='pl-6'    >
                                            <li>Nha khoa Á Châu</li>
                                            <li>Địa chỉ: 32 Phó Đức Chính, Trúc Bạch, Ba Đình, Hà Nội</li>
                                        </ul>
                                    </div>
                                </AccordionTab>
                                <AccordionTab className='text-2xl' header="Quy trình khám chữa bệnh tại Nha khoa Á Châu">
                                    <div className='pb-5'>
