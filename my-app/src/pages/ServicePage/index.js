                ...
                {service?.map((data, index) => {
                    return <div className='grid gap-8 mb-8' key={index}>
                        <div className='col-12 md:col-5 lg:col-5'>
                            {/* <img width='100%' src={"https://www.nhakhoaquocteachau.vn/" + data.image} /> */}
                            <img width='100%' src={data.image !== "" ? "https://www.nhakhoaquocteachau.vn/" + data.image : "https://res.cloudinary.com/dbpw1enlu/image/upload/v1671627690/image-not-available_bvdxhk.png"} />
                        </div>
